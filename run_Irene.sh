...
prompts=("turn her into a rabbit" "Make her look like a cyborg" "Make her James Bond")
...
for prompt in "${prompts[@]}"; do
    ...
    /home/lucky/miniconda3/envs/igs2gs_custom/bin/python  ../nerfstudio/nerfstudio/scripts/train.py \
        igs2gs \
        --vis wandb \
        --experiment-name Irene_grn_"$prompt" \
        --pipeline.model.cull_alpha_thresh 0.005 \
        --pipeline.model.output-depth-during-training True \
        --pipeline.model.use_scale_regularization True \
        --data /home/lucky/dataset/thesis_nerfstudio_data/coord_corrected/Irene_grn/ \
        --load-dir ./outputs/Irene_grn/splatfacto/2024-10-21_181839/nerfstudio_models \
        --pipeline.prompt "$prompt" \
        --pipeline.guidance-scale 5 \
        --pipeline.image-guidance-scale 2 \
        --pipeline.dataset-name Irene \
        nerfstudio-data \
        --eval_mode all \
        --downscale-factor 4 \
        --load-3D-points True \
