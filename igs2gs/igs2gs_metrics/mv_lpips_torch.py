...
def compute_lpips_torch(
    ...
    for i in range(len(masked_batch)):
        ...
        results.append(lpips_val.mean().item())
...
def compute_lpips_per_iter(data_dir, adjacency_batch, lpips_model, save_folder, results_name="Ephra"):
    ...
    for central_idx in range(0, len(adjacency_batch)):
        ...
        # Compute LPIPS
        average_lpips = compute_lpips_torch(
...
if __name__ == "__main__":
    ...
    for folder in folders:
        ...
        lpips_plane, lpips_line = compute_lpips_per_iter(
            data_dir=folder,
