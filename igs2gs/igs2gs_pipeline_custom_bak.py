    ...
    def get_train_loss_dict(self, step: int):
        ...
        if not self.makeSquentialEdits:
            ...
            print(
                "------------ ",
                __file__,
                f"------------ makeSquentialEdits set to True at {step}. Starts editing image idx {self.curr_edit_idx}",
            )
            # get index
            ...
            print(
                "------------ ", __file__, f"------------ finished editing and updating image idx {self.curr_edit_idx}"
            )
